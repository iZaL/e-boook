...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('modules.user.profile',
            ['books' => $allbooks, 'favoriteBooks' => $favoriteBooks, 'user' => $this->authUser, 'orders' => $orders]);
    ...
    public function update(Request $request)
    {
        ...
        if (Session::get('role.admin')) {
            $user = $this->userRepository->model->where('id', '=',
                $request->input('id'))->update($request->except('_token', 'id', 'role_name'));
        ...
        $user = $this->userRepository->model->where('id', '=', $request->input('id'))->update($request->except('_token',
            'id', 'active', 'role_name'));
