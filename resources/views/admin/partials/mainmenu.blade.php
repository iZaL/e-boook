    ...
    <div class="col-xs-12">
        ...
        <nav class="navbar navbar-inverse main-nav" role="navigation">
            <div class="navbar-header">
                <a class="navbar-brand" href="/admin"><i class="fa fa-mortar-board"></i>&nbsp;{{ trans('word.control-panel') }}</a>
                ...
                <ul class="nav navbar-nav navbar-left {{ App::getLocale() == 'ar' ? 'pull-right': '' }}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/admin/book/"><i class="fa fa-pencil fa-fw"></i>&nbsp;{{ trans('word.books') }}</a></li>
                            <li><a href="/admin/book/create"><i class="fa fa-pencil fa-fw"></i>&nbsp;{{ trans('word.create-book') }}</a></li>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="/category"><i class="fa fa-folder-open-o fa-aw"></i>&nbsp;{{ trans('word.categories') }} <b
                                    class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="/category/create"><i class="fa fa-indent fa-fw"></i>&nbsp;{{ trans('word.categories') }}</a></li>
                            <li><a href="/category/create"><i class="fa fa-indent fa-fw"></i>&nbsp;{{ trans('word.create-category') }}</a></li>
                        </ul>
                    <li><a href="/admin/contactus/edit"><i class="fa fa-indent fa-fw"></i>&nbsp;{{ trans('word.contact-us') }}</a></li>
                    </li>
